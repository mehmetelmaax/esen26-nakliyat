...
- **Direct Phone Link**: `+90 532 012 60 26` (Wrapped in `tel:` link)
- **Trust Strip**: [ K3 Yetki Belgeli · 20 Yıllık Eskişehir Firması · Sabit Fiyat Garantisi ]

### SLIDE 1: Primary Value Proposition + Money Keyword (H1)
- **Headline**: Eskişehir Evden Eve Nakliyatta Sabit Fiyat
...
- **Visual Direction**: A close-up shot of a modern, clean moving truck with the "Esen 26 Evden Eve" branding, parked on an Eskişehir street. Natural sunlight, clean focus. No generic graphics.
- **Turkish Alt Text**: Esen 26 Nakliyat asansörlü ev taşıma aracı sokakta park halinde.
- **Slide-level Trust Line**: Sözleşmeli ve sigortalı taşımacılık yapıyoruz.

### SLIDE 2: Geographic & Route Authority (H2)
- **Headline**: Tepebaşı ve Odunpazarı’da Asansörlü Taşıma
- **Line Break Specification (at 380px)**:
  `Tepebaşı ve Odunpazarı’da`
  `Asansörlü Taşıma`
- **Subheadline**: Eskişehir'in tüm ilçelerinde yüksek katlı binalara kendi mobil eşya asansörlerimizle ulaşıyoruz.
- **Visual Direction**: An exterior view of a modern high-rise building in Odunpazarı district. A red-and-white metal ladder elevator is extended up to a 10th-floor balcony, carrying padded furniture packages.
- **Turkish Alt Text**: Tepebaşı'da asansörlü nakliyat aracı eşyaları yüksek kata çıkarıyor.
...
- **Turkish Alt Text**: Esen 26 Nakliyat marangoz personeli yatak odasında dolap kurulumu yapıyor.
...
- **Label**: Eskişehir Yerel Tecrübesi
- **Support Line**: 2006 yılından beri Tepebaşı merkezli olarak Eskişehir genelinde hizmet veriyoruz.
...
"Esen 26 Nakliyat ile Tepebaşı'dan Odunpazarı'ya taşındık. Taşıma günü dedikleri saatte geldiler. Gardırobu söküp yeni evde aynen kurdular. Fiyat başta ne konuştursak o oldu, ekstra masraf çıkmadı. Teşekkürler."
- [Mehmet K., Tepebaşı → Odunpazarı]
```
...
- **Outcome Line**: Eskişehir'den Türkiye'nin tüm illerine sigortalı ve zamanında teslimat.
- **Mechanics**:
...
- **Outcome Line**: Eskişehir merkez ilçeleri arasında aynı gün içinde sorunsuz ev teslimi.
- **Mechanics**:
  - Tepebaşı-Odunpazarı hızlı servis
...
- **Best For**: İş kesintisi yaşamak istemeyen Eskişehir esnafı ve şirketleri.
...
- **A4**: Mobil asansörlü araçlarımız kamyonet boyutlarındadır ve standart Eskişehir sokaklarına rahatça giriş yapabilir. Sadece çok dar sokaklarda park önlemi alınması gerekir. Taşıma öncesi ekiplerimiz sokağın durumunu inceler.
...
> *"Esen 26 Nakliyat olarak taşıdığımız mobilyalarda oluşabilecek darbe veya kırılmaları marangoz ekibimizle yerinde onarır, onarılamayacak hasarları nakit olarak karşılarız."*
...
- **CTAs**: Large button `[Teklif Al]` (Orange background, Navy label) and phone link `0532 012 60 26` highlighted.
