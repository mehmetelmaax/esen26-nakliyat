# Esen 26 Nakliyat - Kurumsal Web Sitesi

Bu proje, Esen Nakliyat & Temizlik & Kolileme firması için özel olarak geliştirilmiş; **SEO Otoritesi (Topical Authority), Core Web Vitals (Hız & Performans), Erişilebilirlik (WCAG AA), Dönüşüm Optimizasyonu ve Güvenli Kurumsal Altyapı** odaklı modern bir Next.js 16 uygulamasıdır.
...
| `NOTIFY_EMAIL` | Teklifler geldiğinde bildirim gönderilecek yönetici adresi. | firmanın resmi e-postası (örn: `info@esen26nakliyat.com`). |
