...
export default function SehiriciPage() {
  ...
  },
  {
    ...
    "answer": "Evet. Taşıma öncesinde hazırlanan resmi nakliyat sözleşmesi gereği, taşınma sırasında oluşabilecek hasarlar Esen 26 Nakliyat yasal sorumluluğundadır."
  },
  {
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Tepebaşı, Odunpazarı ve Sivrihisar başta olmak üzere Eskişehir içi sorunsuz ev taşıma çözümleri.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl">
              Tepebaşı ve Odunpazarı Arası Taşıma Fiyatı Nasıl Belirlenir?
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Tepebaşı ve Odunpazarı arasındaki 1 ev taşıma fiyatı, dairenizin oda sayısına, binaların kat yüksekliklerine ve asansör kurulum durumlarına göre belirlenmektedir. Kat yüksekliği arttıkça işçilik ve dış cephe asansör kurulum maliyeti toplam fiyata yansıtılır.
            </p>
              ...
              <table className="w-full text-left border-collapse border border-gray-300">
                ...
                <tbody className="text-sm">
                  <tr className="bg-white">
                    ...
                    <td className="p-3 border border-gray-300 text-center">12.000 TL - 18.000 TL</td>
                  </tr>
                  <tr className="bg-off-white">
                    <td className="p-3 border border-gray-300">2+1 Şehir İçi Taşıma</td>
                    <td className="p-3 border border-gray-300 text-center">18.000 TL - 23.000 TL</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="p-3 border border-gray-300">3+1 Şehir İçi Taşıma</td>
                    <td className="p-3 border border-gray-300 text-center">23.000 TL - 32.000 TL</td>
                  </tr>
                </tbody>
              </table>
            </div>
