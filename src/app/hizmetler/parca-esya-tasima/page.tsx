...
export default function ParcaEsyaTasimaPage() {
  const parcaFaqs = [
    ...
    },
    {
      ...
      answer: 'Evet. Eskişehir merkezli Tepebaşı garajımızdan Ankara, İstanbul, İzmir, Bursa ve diğer tüm şehirlere düzenli olarak sefer yapan parsiyel taşıma tırlarımızla, tekil eşyalarınızı çok uygun ve avantajlı maliyetlerle adrese teslim gönderiyoruz.'
    },
    {
      ...
      <main className="pt-24 bg-off-white min-h-screen">
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Firmamız, Eskişehir Tepebaşı ve Odunpazarı başta olmak üzere her türlü kısmi eşya taşıma ihtiyacınıza özel araç ve ekip sağlamaktadır. En sık hizmet verdiğimiz senaryolar şunlardır:
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Az miktarda eşya taşınsa dahi yolda oluşabilecek kaza, devrilme veya yangın gibi risklere karşı güvence altında olmanız gerekir. Esen 26 Nakliyat olarak, parça eşya taşıma işlemlerimizin tamamında nakliye sigortasını standart olarak yapmaktayız. Taşınma öncesinde eşyanızın cinsi ve tahmini piyasa değeri tespit edilerek poliçeye işlenir. Yolculuk esnasında meydana gelebilecek hasarlar sigorta acentemiz tarafından karşılanır. Güvenliğiniz ve memnuniyetiniz bizim için her zaman ön plandadır.
            </p>
          </div>
          ...
          <div className="bg-navy/5 border border-navy/10 rounded-xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <Link href="/eskisehir-nakliyat-fiyatlari" className="text-orange-text hover:underline font-bold">
              ...
              <Link href="/bolgeler/tepebasi-evden-eve-nakliyat" className="text-orange-text hover:underline font-bold">
                → Tepebaşı Bölgesi Nakliye Çözümleri
              </Link>
              <Link href="/bolgeler/odunpazari-evden-eve-nakliyat" className="text-orange-text hover:underline font-bold">
                → Odunpazarı Bölgesi Nakliye Çözümleri
              </Link>
