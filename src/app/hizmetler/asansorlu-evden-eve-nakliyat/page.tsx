...
export const metadata: Metadata = {
  ...
  description: `Eskişehir'de yüksek katlı daireler için ${FACTS.maxFloor}. kata kadar ulaşan mobil dış cephe eşya asansörü kiralama ve güvenli asansörlü evden eve nakliye hizmeti.`,
  alternates: {
  ...
  openGraph: {
    title: 'Eskişehir Asansörlü Ev Taşıma | Esen 26 Nakliyat',
    description: 'Eskişehir\'de yüksek katlı daireler için ${FACTS.maxFloor}. kata kadar ulaşan mobil dış cephe eşya asansörü kiralama ve güvenli asansörlü evden eve nakliye hizmeti.',
    url: '/hizmetler/asansorlu-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Eskişehir Asansörlü Ev Taşıma | Esen 26 Nakliyat' }],
  },
};
...
export default function AsansorluPage() {
  const sss = [
    ...
    },
    {
      ...
      "answer": `Esen 26 Nakliyat olarak 1. kattan başlayarak maksimum ${FACTS.maxFloor}. kata kadar ulaşan mobil dış cephe eşya asansörleriyle hizmet vermekteyiz.`
    }
  ];
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Eskişehir Asansörlü Ev Taşıma | Esen 26 Nakliyat',
        description: 'Eskişehir\'de yüksek katlı daireler için ${FACTS.maxFloor}. kata kadar ulaşan mobil dış cephe eşya asansörü kiralama ve güvenli asansörlü evden eve nakliye hizmeti.',
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Esen 26 Hizmetleri', url: '/#hizmetlerimiz' }, { name: 'Asansörlü Nakliyat', url: '/hizmetler/asansorlu-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Tepebaşı ve Odunpazarı ilçelerindeki yüksek katlı binalar için tasarlanan dış cephe mobil taşıma asansör sistemimiz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Esen 26 Nakliyat asansörlü taşıma platformları, eşyaların bina merdiven boşluklarında darbe almasını, çizilmesini ve kırılmasını engellemektedir. Ayrıca, apartman sakinlerini rahatsız etmeden taşınma süresini ortalama yüzde 40 oranında kısaltarak zamandan tasarruf sağlar.
            </p>
          </div>
