      ...
      <main className="pt-24 bg-off-white min-h-screen">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight px-4">
            Eskişehir Eşya Depolama Hizmeti
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Ev veya iş yeri eşyalarınızı, Eskişehir Tepebaşı merkezli güvenlik kameralı, rutubetsiz, sigortalı ve kişiye özel kiralık konteyner depolarımızda güvenle saklıyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Esen 26 Nakliyat kiralık depo ücretleri, eşyaların toplam hacmine göre mini, orta ve büyük boy konteyner hacimlerine bölünerek fiyatlandırılır. Tesislerimizde yer alan standart konteyner depo seçenekleri ve kapasiteleri şu şekildedir:
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Esen 26 Nakliyat depolarında saklanması yasak olan maddeler, kimyasal ve yanıcı materyallerin yol açabileceği yangın riskini önlemek için sıkı kurallara tabidir. Tüm müşterilerimizin eşyalarının güvenliğini ve hijyenini en üst seviyede tutmak adına depolarımızda bazı maddelerin saklanması kesinlikle yasaktır: akaryakıt, tiner, boya, tüp, bozulabilir gıdalar ve yasal ruhsatı bulunmayan tüm patlayıcı ve tehlikeli emtialar bu yasak kapsamındadır.
            </p>
          </div>
