...
export default function PiyanoVeKasaTasimaPage() {
  const piyanoFaqs = [
    ...
    },
    {
      ...
      answer: 'Evet. Esen 26 Nakliyat bünyesinde taşıdığımız her değerli ve ağır enstrüman/kasayı, taşınma öncesinde eşyanın net beyan edilen güncel piyasa değerine göre özel emtia sigortası kapsamına alarak yola çıkarıyoruz.'
    },
    {
      ...
      <main className="pt-24 bg-off-white min-h-screen">
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Özel eğitimli Esen 26 Nakliyat ekipleri ve teknik donanımımızla taşımasını gerçekleştirdiğimiz değerli ve ağır eşya grupları şunlardır:
            </p>
