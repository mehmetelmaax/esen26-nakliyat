...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: '/hizmetler/profesyonel-esya-paketleme',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Profesyonel Eşya Paketleme Hizmeti | Esen 26 Nakliyat' }],
  },
};
...
export default function PaketlemePage() {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Profesyonel Eşya Paketleme Hizmeti | Esen 26 Nakliyat',
        description: 'Eskişehir',
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Esen 26 Nakliyat ambalajlama işlemlerinde kalın patpat olarak adlandırılan çift katlı balonlu naylonlar, Kraft koruma kağıtları ve 5 katmanlı oluklu mukavva koliler kullanmaktadır. Bu özel malzemeler, beyaz eşya saclarının çizilmesini ve ahşap mobilya köşelerinin ezilmesini engeller.
            </p>
