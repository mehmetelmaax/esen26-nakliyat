...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      tags: ['Eskişehir Evden Eve Nakliyat', 'Asansörlü Taşımacılık', 'Ev Taşıma Fiyatları']
    },
    twitter: {
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const relatedLinks: Record<string, {
    ...
    'eskisehir-nakliyat-fiyatlari': {
      ...
      services: [
        { title: 'Eskişehir Ücretsiz Ekspertiz Hizmeti', href: '/hizmetler/ucretsiz-ekspertiz' },
        { title: 'Ev Taşıma Fiyatı Hesaplama Formu', href: '/teklif-al' }
      ],
      districts: [
        { title: 'Tepebaşı Evden Eve Nakliyat Hizmetleri', href: '/bolgeler/tepebasi-evden-eve-nakliyat' },
        { title: 'Odunpazarı Evden Eve Nakliyat Hizmetleri', href: '/bolgeler/odunpazari-evden-eve-nakliyat' }
      ]
    },
    'esya-paketleme-rehberi': {
      blogs: [
        { title: 'Eskişehir Evden Eve Nakliyat Fiyatları Nasıl Belirlenir?', href: '/blog/eskisehir-nakliyat-fiyatlari' },
        { title: 'Mobil Asansörlü Taşımacılık Avantajları', href: '/blog/asansorlu-tasima-avantajlari' }
      ],
      services: [
        { title: 'Profesyonel Eşya Paketleme Hizmeti', href: '/hizmetler/profesyonel-esya-paketleme' },
        { title: 'Eskişehir Şehir İçi Ev Taşıma Çözümleri', href: '/hizmetler/sehirici-evden-eve-nakliyat' }
      ],
      districts: [
        { title: 'Sivrihisar Evden Eve Nakliyat Hizmetleri', href: '/bolgeler/sivrihisar-evden-eve-nakliyat' },
        { title: 'Çifteler Evden Eve Nakliyat Hizmetleri', href: '/bolgeler/cifteler-evden-eve-nakliyat' }
      ]
    },
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-2xl border border-gray-light overflow-hidden shadow-sm p-6 md:p-10 space-y-8">
            ...
            <div className="relative aspect-video w-full rounded-xl bg-navy/5 overflow-hidden border border-gray-light flex items-center justify-center">
              ...
              <Image
                src={post.image}
                alt={`Esen Nakliyat & Temizlik & Kolileme blog makalesi kapak resmi: ${post.title}`}
                width={1200}
                height={630}
                priority
