...
export default function TeklifAlPage() {
  const teklifFaqs = [
    {
      question: 'Eskişehir evden eve nakliyat fiyatları ne kadar?',
      answer: 'Eskişehir evden eve nakliyat fiyatları 2026 yılı itibarıyla taşınacak odaların sayısına, asansör ihtiyacına ve Tepebaşı merkezli taşıma mesafesine göre 12.000 TL ile 32.000 TL arasında değişmektedir.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Esen 26 Nakliyat olarak sözleşmeli ve sabit fiyat garantili çalışmaktayız. Eşya detayları ve taşınma şartları değişmediği sürece anlaştığımız fiyat taşınma günü asla değişmez.'
    },
    {
