...
export default function FiyatlarPage() {
  const pricingFaqs = [
    {
      question: "Eskişehir'de oda sayısına göre ev taşıma fiyatları nasıl değişir?",
      answer: "Esen 26 Nakliyat bünyesinde oda sayısı arttıkça taşınacak eşya hacmi, kullanılacak koruyucu ambalaj malzemesi miktarı ve çalışacak uzman personel sayısı artar. Örneğin, 1+1 dairelerin nakliyesi ortalama 3 personel gerektirirken, 3+1 veya 4+1 daireler marangoz dahil en az 5-6 kişilik bir nakliye ekibi gerektirdiğinden maliyeti doğrudan etkiler."
    },
    {
    ...
    },
    {
      ...
      answer: "Evet, Esen 26 Nakliyat tarafından sunulan tüm standart ev taşıma fiyatlarına gardırop, yatak odası üniteleri, TV üniteleri de-montaj ve montaj işlemleri ile çamaşır ve bulaşık makinesi bağlantıları dahildir. Ekstra marangoz montaj işçilik farkı kesinlikle talep edilmez."
    },
    {
      question: "Eskişehir ilçeler arası nakliyat fiyatları mesafeye göre nasıl hesaplanır?",
      answer: "Tepebaşı merkezli ana garajımızdan sevk edilen araçların Sivrihisar, Çifteler, Alpu, Mihalıççık veya Beylikova gibi çevre ilçelere olan uzaklıkları gidiş-dönüş kilometre hesabı yapılarak akaryakıt giderleri üzerinden tablolandırılır. Mesafe uzadıkça yol yevmiyeleri ve yakıt maliyeti toplam fiyata eklenmektedir."
    },
    {
      question: "Sigortalı evden eve taşımacılık ekstra ücrete tabi midir?",
      answer: "Hayır. Esen 26 Nakliyat olarak yürüttüğümüz her nakliye faaliyeti, eşyalarınızın yoldaki kaza, yangın, devrilme gibi hasar risklerine karşı ücretsiz emtia taşıma sigortası kapsamına alınarak gerçekleştirilir. Sigorta poliçesi taşınma öncesinde adınıza düzenlenmektedir."
    },
    {
    ...
    },
    {
      ...
      answer: "Şehirlerarası nakliye fiyat tekliflerimizde tüm otoban geçiş, otoyol, köprü ve feribot ücretleri Esen 26 Nakliyat’a aittir. Müşterilerimize sonradan yol masrafı adı altında herhangi bir ek gider yansıtılmamaktadır."
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      ...
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Fiyat Rehberi', url: '/eskisehir-nakliyat-fiyatlari' }
      ]),
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white min-h-screen">
        <Breadcrumb items={[{ name: 'Fiyat Rehberi', url: '/eskisehir-nakliyat-fiyatlari' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight px-4">
            Eskişehir Evden Eve Nakliyat Fiyatları
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Eskişehir genelinde ev taşıma maliyetlerini belirleyen tüm operasyonel etkenler ve güncel bütçe tarifeleri bu sayfada listelenmektedir. Esen 26 Nakliyat olarak, tüm taşınma bütçelerinizi şeffaf bir şekilde analiz etmeniz için interaktif hesaplama robotumuzu sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 text-center mb-8">
            ...
            <p className="text-charcoal text-sm max-w-xl mx-auto">
              Esen 26 Nakliyat maliyet hesaplayıcı robotumuz, dairenizin oda durumunu ve asansör gereksinimlerini analiz ederek tahmini bütçeyi anında çıkartır.
            </p>
          </div>
          <PriceCalculator />
        </section>

        {/* Section 1: Eskişehir'de Ev Taşıma Ne Kadar Tutar? */}
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl">
              Eskişehir'de Ev Taşıma Ne Kadar Tutar?
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Eskişehir'de ev taşıma maliyetleri 2026 yılı itibarıyla oda sayısına, asansör durumuna ve mesafeye bağlı olarak ortalama ₺8.000 ile ₺22.000 arasında değişmektedir. Eşyaların hacmi, taşınacak katların yükseklikleri, ambalajlama ve paketleme kalitesi ile marangozluk işçiliği bu bütçe aralığını doğrudan belirleyen temel bileşenlerdir.
            </p>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
        ...
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Esen 26 Nakliyat, Evden eve nakliye tekliflerinde yer alan bütçe aralıkları, sekiz ana lojistik kalemin birleşiminden meydana gelmektedir. Bu etkenler, her müşterinin taşınma şartlarına göre ayrı ayrı hesaplanır:</p>
        ...
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Esen 26 Nakliyat tarafından kullanılan dış cephe mobil teleskopik eşya asansörleri, yüksek katlı binalardaki eşyaların bina içi merdivenlere sokulmadan pencere veya balkondan nakliye aracına transfer edilmesini sağlayan teleskopik platform sistemidir. Esen 26 Nakliyat asansör filosu bünyesindeki araçların tek taraflı kurulum maliyeti 2.500 TL olarak yansıtılmaktadır. Hem yükleme yerinde hem de teslimat yerinde asansör kurulması gerekirse asansör maliyeti 5.000 TL olarak fiyata yansır. Binada yük asansörü olması ve site yönetiminin buna izin vermesi durumunda bu ücretten tasarruf sağlanmaktadır.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Şehirlerarası ev taşıma fiyatları, Tepebaşı merkez garajımızdan çıkış yapacak aracın gideceği hedef şehir arasındaki kilometre bazlı mesafe hesabı yapılarak belirlenmektedir. Hesaplama formülü şu şekildedir:
            </p>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs md:text-sm">
                <caption>Eskişehir Çıkışlı Şehirlerarası Ev Taşıma Rota ve Fiyat Listesi</caption>
                <thead>
                ...
                <tbody className="divide-y divide-gray-light">
                  <tr className="hover:bg-off-white/50">
                    <th scope="row" className="p-3 font-bold text-navy">Eskişehir - Ankara Nakliyat</th>
                    <td className="p-3">490 km</td>
                    <td className="p-3 font-semibold text-orange-text">₺24.000 - ₺28.000</td>
                  </tr>
                  <tr className="hover:bg-off-white/50">
                    <th scope="row" className="p-3 font-bold text-navy">Eskişehir - İstanbul Nakliyat</th>
                    <td className="p-3">930 km</td>
                    <td className="p-3 font-semibold text-orange-text">₺35.000 - ₺42.000</td>
                  </tr>
                  <tr className="hover:bg-off-white/50">
                    <th scope="row" className="p-3 font-bold text-navy">Eskişehir - İzmir Nakliyat</th>
                    <td className="p-3">900 km</td>
                    <td className="p-3 font-semibold text-orange-text">₺34.000 - ₺40.000</td>
                  </tr>
                  <tr className="hover:bg-off-white/50">
                    <th scope="row" className="p-3 font-bold text-navy">Eskişehir - Mersin Nakliyat</th>
        ...
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Esen 26 Nakliyat, Hangi taşıma firmasıyla anlaşırsanız anlaşın, taşınma gününde mağduriyet yaşamamak adına aşağıdaki on soruluk kontrol listesini firmaya yöneltip teyit almanız yasal haklarınızı korumak adına zorunludur:</p>
        ...
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Eskişehir Nakliyat Fiyatları Hakkında Sıkça Sorulan Sorular Nelerdir?</span>
            </h2>
        ...
        <section className="py-8 max-w-4xl mx-auto px-4">
          <RelatedLinks currentSlug="eskisehir-nakliyat-fiyatlari" type="blog" title="Yararlı Bağlantılar ve Rehberler" />
        </section>
      </main>
    </>
  );
