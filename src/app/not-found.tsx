...
export const metadata: Metadata = {
  title: 'Sayfa Bulunamadı | Esen 26 Nakliyat',
...
export default function NotFound() {
  ...
  const districts = [
    { name: 'Tepebaşı Evden Eve', href: '/bolgeler/tepebasi-evden-eve-nakliyat' },
    { name: 'Odunpazarı Evden Eve', href: '/bolgeler/odunpazari-evden-eve-nakliyat' },
    { name: 'Çifteler Evden Eve', href: '/bolgeler/cifteler-evden-eve-nakliyat' },
    { name: 'Sivrihisar Evden Eve', href: '/bolgeler/sivrihisar-evden-eve-nakliyat' },
  ];
