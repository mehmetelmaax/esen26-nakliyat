...
export const metadata: Metadata = {
  ...
  description: 'Esen Nakliyat & Temizlik & Kolileme Kişisel Verilerin Korunması Kanunu (KVKK) uyarınca veri işleme faaliyetlerimiz hakkında veri sorumlusu aydınlatma metni.',
  alternates: {
