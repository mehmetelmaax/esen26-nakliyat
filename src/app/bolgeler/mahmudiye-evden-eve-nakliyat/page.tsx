...
export const metadata: Metadata = {
  ...
  description: "Eskişehir Mahmudiye ilçesinde Yeni, Işıklar, Çarşı mahallelerinde sigortalı marangozlu ev taşıma ve asansörlü nakliyat. Esen 26 ile güvenle taşının.",
  alternates: {
    canonical: '/bolgeler/mahmudiye-evden-eve-nakliyat',
  },
  robots: {
    index: false,
    follow: true,
...
export default function MahmudiyePage() {
  const name = 'Mahmudiye';
  const sss = [
    {
    ...
    },
    {
      ...
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki mesafe ortalama 50 kilometredir. Eşyaların sökülmesi, paketlenmesi, taşınması ve kurulumu dahil tüm süreç yaklaşık 4 ila 6 saat sürer.`
    },
    {
    ...
    },
    {
      ...
      answer: "Evet. Mahmudiye lojistik operasyonlarımızın tamamında emtia nakliyat sigortası uygulamaktayız. Eskişehir genelinde taşınan eşyalarınız Anadolu Sigorta güvencesiyle koruma altındadır."
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Mahmudiye Evden Eve Nakliyat',
        description: "Eskişehir Mahmudiye ilçesinde Yeni, Işıklar, Çarşı mahallelerinde sigortalı marangozlu ev taşıma ve asansörlü nakliyat. Esen 26 ile güvenle taşının.",
        slug: 'bolgeler/mahmudiye-evden-eve-nakliyat',
        areaName: 'Mahmudiye'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Mahmudiye', url: '/bolgeler/mahmudiye-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };

  const mahalleler = ['Yeni', 'Işıklar', 'Çarşı'];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Mahmudiye', url: '/bolgeler/mahmudiye-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          <span className="text-orange-text font-bold text-xs tracking-widest font-sans">
            ESKİŞEHİR MAHMUDIYE BÖLGE OFİSİ
          </span>
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Mahmudiye Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Eskişehir Mahmudiye bölgesinde K3 yetki belgeli kapalı kasa tır ve kamyon filomuz, sertifikalı marangoz ekiplerimiz and mobil eşya asansörlerimizle sigortalı ve profesyonel ev taşıma çözümleri üretiyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              <MapPin className="text-orange-text" /> Mahmudiye Bölgesinde Güvenli Ev Taşıma Nasıl Yapılır?
            </h2>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              Esen 26 Nakliyat olarak Mahmudiye ilçesindeki tüm mahallelerde ve sokaklarda profesyonel evden eve nakliye hizmetleri sunmaktayız. Asansörlü nakliye araçlarımız sayesinde yüksek katlı binalardaki dairelerinize de hasarsız, hızlı ve sorunsuz nakliye sağlıyoruz.
            </p>
          </div>
          ...
          {/* Building Analysis */}
          <BuildingAnalysis districtName="Mahmudiye" />
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h3 className="font-display font-bold text-navy text-xl">
              Mahmudiye Hizmet Verdiğimiz Mahalleler
            </h3>
          ...
          <div className="bg-navy rounded-2xl p-8 md:p-12 text-white text-center space-y-6">
            <h3 className="font-display font-black text-2xl md:text-3xl">
              Mahmudiye Taşınma Fiyatınızı Şimdi Öğrenin
            </h3>
          ...
          <section className="py-12 bg-white rounded-xl border border-gray-light p-8 max-w-4xl mx-auto space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl">
              Mahmudiye İlçesinde Profesyonel Ev Taşıma Kılavuzu Neler Sunuyor?
            </h2>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              Eskişehir’in en önemli bölgelerinden biri olan Mahmudiye ilçesinde evden eve nakliyat süreçleri, bölgenin mimari yapısı ve coğrafi özelliklerine göre özel bir planlama gerektirir. Esen 26 Nakliyat olarak, bu bölgede yıllardır edindiğimiz deneyimle taşınma sürecinizi stressiz ve sorunsuz hale getiriyoruz. İlçe genelinde gerek dar sokaklar gerekse modern yüksek katlı binalar için geliştirdiğimiz özel lojistik çözümlerimiz sayesinde eşyalarınız kırılma, çizilme veya kaybolma riski olmadan taşınır.
            </p>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
            ...
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              Eşyalarınızın güvenliği bizim için ilk sıradadır. Bu nedenle, taşıma esnasında kullandığımız ambalaj malzemeleri birinci sınıf kalitede balonlu patpat naylonlar, özel karton kutular ve mukavva köşebentlerden oluşur. Eskişehir Mahmudiye nakliye operasyonlarımızın tamamında Anadolu Sigorta güvencesiyle emtia nakliyat sigortası uygulayarak eşyalarınızı yolculuk boyunca güvence altına alıyoruz.
            </p>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
          ...
          <RelatedLinks currentSlug="mahmudiye-evden-eve-nakliyat" type="bolge" />
        </section>
      </main>
    </>
  );
