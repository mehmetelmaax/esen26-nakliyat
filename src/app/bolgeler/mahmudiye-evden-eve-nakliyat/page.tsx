...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Mahmudiye Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Mahmudiye ilçesinde Işıklar, Yeni ve Yeni Mahalle mahallelerinde Esen 26 ile sigortalı asansörlü evden eve taşımacılık.',
    url: '/bolgeler/mahmudiye-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Mahmudiye Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function MahmudiyePage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Mahmudiye'nin stabilize tarla ve çiftlik yollarından kaynaklanan tozlanmaya karşı eşyalarınızı kalın naylon patpatlar ve streç ambalajlarla koruyoruz.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 55 kilometredir. Mahmudiye ile merkez şubemiz arasındaki nakliye güzergahı 55 km'dir ve tır intikali yaklaşık 50 dakika içinde tamamlanır.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Mahmudiye Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Mahmudiye ilçesinde Işıklar, Yeni ve Yeni Mahalle mahallelerinde Esen 26 ile sigortalı asansörlü evden eve taşımacılık.',
  ...
  const mahalleler = ['Işıklar', 'Yeni', 'Mesudiye', 'Orta', 'Cumhuriyet'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Devlet Haraları ve ünlü at çiftlikleriyle bilinen Mahmudiye'de, tarım ve hayvancılık alanlarının geniş yollarına uygun büyük boy nakliye araçlarımızla ev taşıma hizmeti sunuyoruz. Toz ve dış etken korumalı kapalı kasa sistemlerimizle eşyalarınızı sevk ediyoruz.
          </p>
        </section>
