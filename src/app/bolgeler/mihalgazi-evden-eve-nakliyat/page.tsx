...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Mihalgazi Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Mihalgazi ilçesinde Cumhuriyet, Hürriyet ve Dokuz Mayıs mahallelerinde Esen 26 ile güvenli ev taşıma hizmetleri.',
    url: '/bolgeler/mihalgazi-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Mihalgazi Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function MihalgaziPage() {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Mihalgazi Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Mihalgazi ilçesinde Cumhuriyet, Hürriyet ve Dokuz Mayıs mahallelerinde Esen 26 ile güvenli ev taşıma hizmetleri.',
      ...
      breadcrumbSchema([
        ...
        { name: 'Mihalgazi', url: '/bolgeler/mihalgazi-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Mihalgazi', url: '/bolgeler/mihalgazi-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          <span className="text-orange-text font-bold text-xs tracking-widest font-sans">
            ESKİŞEHİR MIHALGAZI BÖLGE OFİSİ
          </span>
