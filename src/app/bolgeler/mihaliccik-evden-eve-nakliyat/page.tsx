...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Mihalıççık Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Mihalıççık ilçesinde Camikebir, Medrese ve Yenimahalle mahallelerinde Esen 26 ile sigortalı marangozlu ev taşıma.',
    url: '/bolgeler/mihaliccik-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Mihalıççık Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function MihalıççıkPage() {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Mihalıççık Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Mihalıççık ilçesinde Camikebir, Medrese ve Yenimahalle mahallelerinde Esen 26 ile sigortalı marangozlu ev taşıma.',
