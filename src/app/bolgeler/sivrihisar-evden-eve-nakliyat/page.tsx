...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Sivrihisar Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Sivrihisar ilçesinde Kurşunlu, Camikebir ve Hızırbey mahallelerinde Esen 26 ile sigortalı asansörlü ev taşıma.',
    url: '/bolgeler/sivrihisar-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Sivrihisar Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: true,
    follow: true,
...
export default function SivrihisarPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Sivrihisar'ın yüksek tepelerinde esen sert rüzgarlı havalarda, asansör raylarını binaya çelik gergi telleriyle ekstra sabitleyerek güvenliği üst düzeye çıkarıyoruz.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 95 kilometredir. Sivrihisar ilçesi merkez ofisimize 95 km mesafede olup, nakliyat tırlarımızın seyir süresi yaklaşık 1 saat 15 dakikadır.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Sivrihisar Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Sivrihisar ilçesinde Kurşunlu, Camikebir ve Hızırbey mahallelerinde Esen 26 ile sigortalı asansörlü ev taşıma.',
  ...
  const mahalleler = ['Kurşunlu', 'Camikebir', 'Hızırbey', 'Karacalar', 'Elmalı'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Saat Kulesi ve Ulu Cami gibi UNESCO miraslarına ev sahipliği yapan Sivrihisar ilçesinde, tarihi taş sokaklara ve sert rüzgarlara uyumlu güvenli ev taşıma hizmetleri sunuyoruz. Tarihi dar konak kapılarına uygun asansörlü nakliye kurmaktayız.
          </p>
        </section>
