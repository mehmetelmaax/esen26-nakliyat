...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Tepebaşı Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Tepebaşı ilçesinde Batıkent, Şirintepe, Çamlıca ve Uluönder mahallelerinde Esen 26 ile sigortalı asansörlü nakliyat.',
    url: '/bolgeler/tepebasi-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Tepebaşı Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: true,
    follow: true,
...
export default function TepebaşıPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Tepebaşı ilçesindeki yeni rezidans projlerinde bina yönetimi kuralları gereği bina içi asansörler yerine doğrudan kendi dış cephe teleskopik yük asansörlerimizi kullanmaktayız.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 5 kilometredir. Tepebaşı bölgesindeki şehir içi nakliye ve kurulum işlemlerimiz ortalama 4-6 saat sürmektedir.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Tepebaşı Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Tepebaşı ilçesinde Batıkent, Şirintepe, Çamlıca ve Uluönder mahallelerinde Esen 26 ile sigortalı asansörlü nakliyat.',
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Eskişehir'in modern, yüksek katlı yerleşim yerlerinden Tepebaşı ilçesinde, rezidans standartlarında lüks ve asansörlü ev taşıma hizmetleri sağlamaktayız. Haller ve Espark çevresindeki yoğun kent trafiğinde planlı zamanlamayla taşınma sağlıyoruz.
          </p>
        </section>
