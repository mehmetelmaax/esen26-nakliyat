...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Seyitgazi Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Seyitgazi ilçesinde İkiçeşme, Dere ve Yunusemre mahallelerinde Esen 26 ile sigortalı asansörlü ev taşıma hizmetleri.',
    url: '/bolgeler/seyitgazi-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Seyitgazi Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function SeyitgaziPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Seyitgazi'deki dağınık kırsal mahalle yerleşimleri ve engebeli yollar için eşyaları araç içine gerdirmeli kilit halatlarla sımsıkı sabitleyerek hasarsız sevk ediyoruz.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 45 kilometredir. Seyitgazi ile Eskişehir merkez arası nakliye rotası 45 km'dir ve kamyon intikal süresi yaklaşık 50 dakika doğrudur.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Seyitgazi Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Seyitgazi ilçesinde İkiçeşme, Dere ve Yunusemre mahallelerinde Esen 26 ile sigortalı asansörlü ev taşıma hizmetleri.',
  ...
  const mahalleler = ['İkiçeşme', 'Dere', 'Yunusemre', 'Kırka', 'Bardakçı'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Seyyit Battal Gazi Külliyesi ve maden sahaları çevresindeki dağınık mahalle yapısına sahip Seyitgazi'de, geniş coğrafi alana yayılmış nakliye desteği sağlıyoruz. Kırka ve ilçe merkezindeki ev taşımalarınızda sigortalı lojistik sunmaktayız.
          </p>
        </section>
