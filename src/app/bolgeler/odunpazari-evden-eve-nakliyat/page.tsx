...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Odunpazarı Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Odunpazarı ilçesinde Emek, 75. Yıl, Yıldıztepe ve Akarbaşı mahallelerinde Esen 26 ile sigortalı asansörlü ev taşıma.',
    url: '/bolgeler/odunpazari-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Odunpazarı Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: true,
    follow: true,
...
export default function OdunpazarıPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Odunpazarı sit alanlarındaki ahşap konaklar ve dik merdivenli eski binalarda taşınırken dar dönüş açılarına uygun küçük ebatlı taşıma sedyeleri ve askı aparatları kullanmaktayız.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 5 kilometredir. Odunpazarı sınırları içindeki taşıma işlemlerimiz ortalama 4-5 saatlik çalışma ile hasarsız şekilde tamamlanmaktadır.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Odunpazarı Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Odunpazarı ilçesinde Emek, 75. Yıl, Yıldıztepe ve Akarbaşı mahallelerinde Esen 26 ile sigortalı asansörlü ev taşıma.',
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Tarihi Odunpazarı Evleri ve Kurşunlu Külliyesi gibi koruma altındaki sit alanlarında, dar sokak kısıtlamalarına ve tarihi binaların hassasiyetine uygun dar sokak nakliye ekiplerimizle hizmet veriyoruz. Sit alanlarında gürültüsüz ve emniyetli lojistik sağlıyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h3 className="font-display font-bold text-navy text-xl">
              Odunpazarı Hizmet Verdiğimiz Başlıca Mahalleler
            </h3>
          ...
          <section className="py-12 bg-white rounded-xl border border-gray-light p-8 space-y-6">
            ...
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              Odunpazarı'nın sit alanlarındaki dar sokaklarda park sorunlarını aşmak ve tarihi konakların dik merdiven yapılarında eşya taşımak yüksek deneyim ister. Eşyalarınızın merdiven boşluklarında zarar görmemesi amacıyla taşınabilir asansörler ve el vinçleri kullanıyoruz. Zeminlerde oluşabilecek aşınmalara karşı özel parke koruyucu kauçuklar yerleştirilmektedir. Eskişehir'in bu köklü ilçesinde 11 yıllık tecrübemizle yanınızdayız.
            </p>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
