...
export const metadata: Metadata = {
  ...
  description: "Eskişehir Beylikova ilçesinde Yeni, Fatih, Atatürk mahallelerinde sigortalı marangozlu ev taşıma ve asansörlü nakliyat. Esen 26 ile güvenle taşının.",
  alternates: {
    canonical: '/bolgeler/beylikova-evden-eve-nakliyat',
  },
  robots: {
    index: false,
    follow: true,
...
export default function BeylikovaPage() {
  const name = 'Beylikova';
  const sss = [
    {
    ...
    },
    {
      ...
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki mesafe ortalama 70 kilometredir. Eşyaların sökülmesi, paketlenmesi, taşınması ve kurulumu dahil tüm süreç yaklaşık 4 ila 6 saat sürer.`
    },
    {
    ...
    },
    {
      ...
      answer: "Evet. Beylikova lojistik operasyonlarımızın tamamında emtia nakliyat sigortası uygulamaktayız. Eskişehir genelinde taşınan eşyalarınız Anadolu Sigorta güvencesiyle koruma altındadır."
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Beylikova Evden Eve Nakliyat',
        description: "Eskişehir Beylikova ilçesinde Yeni, Fatih, Atatürk mahallelerinde sigortalı marangozlu ev taşıma ve asansörlü nakliyat. Esen 26 ile güvenle taşının.",
        slug: 'bolgeler/beylikova-evden-eve-nakliyat',
        areaName: 'Beylikova'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Beylikova', url: '/bolgeler/beylikova-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };

  const mahalleler = ['Yeni', 'Fatih', 'Atatürk'];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Beylikova', url: '/bolgeler/beylikova-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          <span className="text-orange-text font-bold text-xs tracking-widest font-sans">
            ESKİŞEHİR BEYLIKOVA BÖLGE OFİSİ
          </span>
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Beylikova Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Eskişehir Beylikova bölgesinde K3 yetki belgeli kapalı kasa tır ve kamyon filomuz, sertifikalı marangoz ekiplerimiz and mobil eşya asansörlerimizle sigortalı ve profesyonel ev taşıma çözümleri üretiyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              <MapPin className="text-orange-text" /> Beylikova Bölgesinde Güvenli Ev Taşıma Nasıl Yapılır?
            </h2>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              Esen 26 Nakliyat olarak Beylikova ilçesindeki tüm mahallelerde ve sokaklarda profesyonel evden eve nakliye hizmetleri sunmaktayız. Asansörlü nakliye araçlarımız sayesinde yüksek katlı binalardaki dairelerinize de hasarsız, hızlı ve sorunsuz nakliye sağlıyoruz.
            </p>
          </div>
          ...
          {/* Building Analysis */}
          <BuildingAnalysis districtName="Beylikova" />
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h3 className="font-display font-bold text-navy text-xl">
              Beylikova Hizmet Verdiğimiz Mahalleler
            </h3>
          ...
          <div className="bg-navy rounded-2xl p-8 md:p-12 text-white text-center space-y-6">
            <h3 className="font-display font-black text-2xl md:text-3xl">
              Beylikova Taşınma Fiyatınızı Şimdi Öğrenin
            </h3>
          ...
          <section className="py-12 bg-white rounded-xl border border-gray-light p-8 max-w-4xl mx-auto space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl">
              Beylikova İlçesinde Profesyonel Ev Taşıma Kılavuzu Neler Sunuyor?
            </h2>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              Eskişehir’in en önemli bölgelerinden biri olan Beylikova ilçesinde evden eve nakliyat süreçleri, bölgenin mimari yapısı ve coğrafi özelliklerine göre özel bir planlama gerektirir. Esen 26 Nakliyat olarak, bu bölgede yıllardır edindiğimiz deneyimle taşınma sürecinizi stressiz ve sorunsuz hale getiriyoruz. İlçe genelinde gerek dar sokaklar gerekse modern yüksek katlı binalar için geliştirdiğimiz özel lojistik çözümlerimiz sayesinde eşyalarınız kırılma, çizilme veya kaybolma riski olmadan taşınır.
            </p>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
            ...
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              Eşyalarınızın güvenliği bizim için ilk sıradadır. Bu nedenle, taşıma esnasında kullandığımız ambalaj malzemeleri birinci sınıf kalitede balonlu patpat naylonlar, özel karton kutular ve mukavva köşebentlerden oluşur. Eskişehir Beylikova nakliye operasyonlarımızın tamamında Anadolu Sigorta güvencesiyle emtia nakliyat sigortası uygulayarak eşyalarınızı yolculuk boyunca güvence altına alıyoruz.
            </p>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
          ...
          <RelatedLinks currentSlug="beylikova-evden-eve-nakliyat" type="bolge" />
        </section>
      </main>
    </>
  );
