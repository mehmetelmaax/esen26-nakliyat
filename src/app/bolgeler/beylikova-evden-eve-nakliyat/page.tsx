...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Beylikova Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Beylikova ilçesinde Yeni, Fatih ve Yunusemre mahallelerinde Esen 26 ile sigortalı ambalajlı marangozlu nakliyat çözümleri.',
    url: '/bolgeler/beylikova-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Beylikova Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function BeylikovaPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Beylikova genelinde kırsal alan ve tarlalardan kaynaklanabilecek tozlanmaya karşı kolilerinizi sıkı bantlayıp naylonla sarıyoruz. Araç içi askı sabitleyicilerle sarsıntıyı önlüyoruz.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 75 kilometredir. Beylikova ilçesi merkez ofisimize 75 km uzaklıkta olup, tır seyir süresi yaklaşık 1.5 saat sürmektedir. Taşıma Anadolu Sigorta güvencesindedir.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Beylikova Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Beylikova ilçesinde Yeni, Fatih ve Yunusemre mahallelerinde Esen 26 ile sigortalı ambalajlı marangozlu nakliyat çözümleri.',
  ...
  const mahalleler = ['Yeni', 'Fatih', 'Yunusemre', 'Aşağı', 'Yukarı'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Eskişehir'in önemli hayvancılık ve süt üretim merkezi olan Beylikova'da, uzun mesafe lojistik hatlarımıza uygun emniyetli taşımacılık hizmeti veriyoruz. Organize sanayi bölgesi ve ilçe merkezindeki ev taşıma işlemlerinizde toz geçirmez ambalajlama standartları uygulamaktayız.
          </p>
        </section>
