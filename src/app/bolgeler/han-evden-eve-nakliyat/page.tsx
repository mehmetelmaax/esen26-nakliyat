...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Han Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Han ilçesinde Hacılar, Cumhuriyet ve Selimiye mahallelerinde Esen 26 ile sigortalı antika ve ev eşyası taşımacılığı.',
    url: '/bolgeler/han-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Han Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function HanPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Han ilçesindeki dar tarihi kapı girişlerinde ve sit alanlarında binalara hasar vermemek adına küçük boyutlu transpaletler ve askı halatları kullanmaktayız.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 105 kilometredir. Han ile Eskişehir merkez ofisimiz arasındaki 105 km'lik güzergah dik virajlar içerdiğinden nakliye kamyonlarımızın hızı saatte 60 km ile sınırlandırılır.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Han Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Han ilçesinde Hacılar, Cumhuriyet ve Selimiye mahallelerinde Esen 26 ile sigortalı antika ve ev eşyası taşımacılığı.',
  ...
  const mahalleler = ['Hacılar', 'Cumhuriyet', 'Selimiye', 'Karahisar', 'Gökçeyayla'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Yazılıkaya Midas Anıtı ve Frig Vadisi tarihi mirasına ev sahipliği yapan Han ilçesinde, sit alanı kısıtlamalarına tam uyumlu, hassas nakliye hizmetleri yürütüyoruz. Eski taş binaların ve dar sokakların mimari yapısını bozmadan modüler ekipmanlarımızla nakliye yapmaktayız.
          </p>
        </section>
