...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'İnönü Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir İnönü ilçesinde Çarşı, Orta ve İsmetpaşa mahallelerinde Esen 26 ile sigortalı asansörlü marangozlu ev ve ofis taşıma.',
    url: '/bolgeler/inonu-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'İnönü Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function İnönüPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. İnönü'nün rüzgarlı yüksek tepelerindeki asansör kurulumlarında rüzgar hızı 35 km/s üzerine çıktığında iş güvenliği adına operasyonu rüzgar dinene kadar askıya alıyoruz.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 35 kilometredir. İnönü ile şehir merkezi arasındaki nakliye mesafesi 35 km olup, araç sevk süremiz ortalama 40 dakika sürmektedir.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'İnönü Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir İnönü ilçesinde Çarşı, Orta ve İsmetpaşa mahallelerinde Esen 26 ile sigortalı asansörlü marangozlu ev ve ofis taşıma.',
  ...
  const mahalleler = ['Çarşı', 'Orta', 'İsmetpaşa', 'Yeni', 'Erenler'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            İnönü Mağaraları ve THK Havacılık Merkezi gibi rüzgarlı yüksek yamaç yollarına sahip ilçemizde, rüzgar hızı ölçümlü asansörlü taşıma hizmeti sunuyoruz. Sanayi bölgesi tır trafiğini dikkate alarak taşınma gününüzü organize etmekteyiz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <section className="py-12 bg-white rounded-xl border border-gray-light p-8 space-y-6">
            ...
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
              İnönü bölgesindeki yüksek katlı lojmanlarda ve apartman dairelerinde merdiven kazalarını önlemek amacıyla mobil dış cephe asansörlerimiz 25. kata kadar güvenle uzanır. İnönü'nün yüksek rüzgar alan yamaç yapısına göre asansör sabitleme çelik halatları ekstra mukavemetli gerdirmelerle desteklenir.
            </p>
            <p className="text-gray-medium text-sm md:text-base leading-relaxed">
