...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Çifteler Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Çifteler ilçesinde Sakarya, Çiftçiler ve Erbap mahallelerinde Esen 26 ile profesyonel asansörlü ev taşıma hizmetleri.',
    url: '/bolgeler/cifteler-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Çifteler Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: true,
    follow: true,
...
export default function ÇiftelerPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Çifteler ilçesindeki nehir kenarı nem ve su serpintisi risklerine karşı taşıma kasalarımız neme dayanıklı MDF kaplamalı olup, tüm eşyalarınız su geçirmez ambalajlarla kaplanır.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 65 kilometredir. Çifteler ile Eskişehir merkez ofisimiz arasındaki nakliye mesafesi 65 km'dir ve tır transferi ortalama 1 saat içinde tamamlanır.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Çifteler Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Çifteler ilçesinde Sakarya, Çiftçiler ve Erbap mahallelerinde Esen 26 ile profesyonel asansörlü ev taşıma hizmetleri.',
  ...
  const mahalleler = ['Sakarya', 'Çiftçiler', 'Erbap', 'Yeni', 'Adalar'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Sakaryabaşı'nın eşsuz doğası ve su kaynaklarıyla bilinen Çifteler ilçesinde, nem oranına dayanıklı ambalajlama teknikleriyle korumalı ev taşıma hizmetleri sunuyoruz. Müstakil ve yazlık evlerin yer aldığı ilçemizde dar bahçe girişlerine uygun araçlarımızla lojistik sağlıyoruz.
          </p>
        </section>
