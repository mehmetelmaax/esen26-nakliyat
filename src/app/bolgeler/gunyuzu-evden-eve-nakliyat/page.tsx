...
export default function GünyüzüPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Günyüzü'nün engebeli uzak mesafe yollarında mobilyaların sürtünme hasarını önlemek için her parçayı kat kat battaniye ve patpat naylonlarla sararak paketliyoruz.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 135 kilometredir. Günyüzü ilçesi şehir merkezine en uzak noktamız olup, tır nakliyesi yol durumu dahil 2 saati bulmaktadır. Taşınma tamamen sigortalıdır.`
    },
    {
  ...
  const mahalleler = ['Sümer', 'Yeni', 'Gümüşkonak', 'Fatih', 'Kaymaz'];
      ...
      <main className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            İl merkezine en uzak ilçelerimizden olan Günyüzü'nde, uzun yol mukavemetine sahip özel nakliye filomuzla güvenli ev taşıma hizmeti veriyoruz. Günyüzü Ovası çevresindeki tüm mahallelerde K3 yetki belgeli araçlarımızla eşyalarınızı güvenceye alıyoruz.
          </p>
        </section>
