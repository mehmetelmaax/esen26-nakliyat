...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Alpu Evden Eve Nakliyat | Esen 26 Nakliyat',
    description: 'Eskişehir Alpu ilçesinde Fatih, Kemalpaşa ve Bahçelievler mahallelerinde Esen 26 ile sigortalı marangozlu ev taşıma ve asansörlü nakliyat.',
    url: '/bolgeler/alpu-evden-eve-nakliyat',
    type: 'article',
    modifiedTime: '2026-08-16T08:00:00+03:00',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Alpu Evden Eve Nakliyat | Esen 26 Nakliyat' }],
  },
  robots: {
    index: false,
    follow: true,
...
export default function AlpuPage() {
  ...
  const sss = [
    {
      ...
      answer: `${locativeKi(name)} taşınma operasyonlarında güvenlik en ön planda tutulur. Cihazlarımızın ayakları zemin basıncını dağıtacak takozlarla desteklenerek kurulur. Alpu köy ve yayla yollarında eşyaların tozlanmasını önlemek için tüm paketlerimizi endüstriyel streç film ile çift kat sararak muhafaza altına alıyoruz. Kapalı çelik kasalarımız dışarıdan gelebilecek toz ve yağmura karşı tamamen izoledir.`
    },
    {
      question: `${name} ile Eskişehir merkez ofisiniz arasındaki nakliye ne kadar sürer?`,
      answer: `${name} ile Eskişehir merkez ofisimiz arasındaki taşıma rotası 40 kilometredir. Alpu ile merkez şubemiz arasındaki mesafe yaklaşık 40 km olup, nakliye tırlarımızın seyir süresi ortalama 1 saattir. Tüm taşıma süreci Anadolu Sigorta poliçesi kapsamında güvence altındadır.`
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      webPageSchema({
        name: 'Alpu Evden Eve Nakliyat | Esen 26 Nakliyat',
        description: 'Eskişehir Alpu ilçesinde Fatih, Kemalpaşa ve Bahçelievler mahallelerinde Esen 26 ile sigortalı marangozlu ev taşıma ve asansörlü nakliyat.',
  ...
  const mahalleler = ['Fatih', 'Kemalpaşa', 'Bahçelievler', 'Fevzipaşa', 'Bozyaka'];
