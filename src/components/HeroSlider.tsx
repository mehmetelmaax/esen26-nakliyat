...
const slides: Slide[] = [
  {
    ...
    bgImage: '/img/esen-slayt-1.jpg',
    imageAlt: "Esen Nakliyat & Temizlik & Kolileme büyük boy çelik kasa ev taşıma kamyonu yükleme esnasında"
  },
  {
    id: 2,
    headline: 'Tepebaşı ve Odunpazarı’da\nAsansörlü Taşıma',
    subheadline: "Eskişehir'in tüm mahallelerinde yüksek katlı dairelere kendi mobil eşya asansörlerimizle ulaşıyoruz.",
    trustLine: '25. kata kadar ulaşan eşya asansörü filosu.',
    bgImage: '/img/esen-slayt-2.jpg',
    imageAlt: "Eskişehir Tepebaşı'da çok katlı binalar için 25. kata kadar kurulabilen mobil teleskopik yük ve eşya taşıma asansörü"
  },
  {
    id: 3,
    ...
    bgImage: '/img/esen-slayt-3.jpg',
    imageAlt: "Esen 26 Nakliyat marangoz ekibince yatak odası gardırop demontaj ve paketleme işlemi"
  }
];
...
export default function HeroSlider() {
  ...
  return (
    <section 
      ...
      aria-label="Esen 26 Nakliyat Hizmet Tanıtımı"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-20 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-10 lg:py-0">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center select-none text-left">
          ...
          <div className="border-t border-white/10 mt-8 pt-4 flex flex-wrap gap-4 text-xs md:text-sm text-gray-300 font-semibold">
            ...
            <span className="flex items-center gap-1.5">✓ 20 Yıllık Eskişehir Firması</span>
            <span className="text-white/20">|</span>
