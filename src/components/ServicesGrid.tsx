...
const services: ServiceItem[] = [
  {
    ...
    outcomeLine: 'Eskişehir merkez ilçeleri arasında aynı gün içinde sorunsuz ev teslimi.',
    mechanics: [
  ...
  },
  {
    ...
    outcomeLine: "Eskişehir'den Türkiye'nin tüm illerine sigortalı ve zamanında teslimat.",
    mechanics: [
  ...
  },
  {
    ...
    bestFor: 'İş kesintisi yaşamak istemeyen Eskişehir esnafı ve şirketleri.',
  ...
  {
    id: 'temizlik',
    name: '7. Ev ve Ofis Temizliği',
    searchableName: 'Hijyenik Temizlik Hizmetleri',
    outcomeLine: 'Taşınma öncesi veya sonrasında boş evlerin ve ofislerin derinlemesine dezenfekte edilerek temizlenmesi.',
    mechanics: [
      'TSE onaylı temizlik malzemeleri',
      'İnşaat sonrası alçı/boya temizliği',
      'Buharlı vakumla zemin hijyeni',
    ],
    bestFor: 'Yeni evine taşınmadan önce hijyenik temizlik yaptırmak isteyenler.',
    pricePosture: 'Dairenin büyüklüğüne ve inşaat durumuna göre hesaplanır.',
    microCTA: 'Temizlik Hizmeti Detayları',
    icon: Sparkles,
    route: '/hizmetler/ev-ve-ofis-temizligi',
  },
];
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            {services.map((service) => {
              ...
              return (
                <div 
                  key={service.id}
                  className="bg-white/80 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-gray-light/60 hover:border-orange/40 shadow-premium shadow-premium-hover transition-all duration-300 flex flex-col justify-between group relative overflow-hidden cursor-pointer"
                >
