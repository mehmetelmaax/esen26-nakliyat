  ...
  const initialGroups: ChecklistGroup[] = [
    {
      ...
      items: [
        ...
        { id: '3', task: 'Esen 26 Nakliyat\'tan ücretsiz ön keşif (ekspertiz) talep edin ve sabit fiyat teklifinizi alın.', checked: false },
    ...
    },
    {
      ...
      items: [
        ...
        { id: '18', task: 'Esen 26 Nakliyat müşteri temsilcisiyle iletişime geçerek araç varış saatini ve ekibi teyit edin.', checked: false },
