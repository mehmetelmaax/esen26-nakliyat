  ...
  return (
    <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6 text-charcoal">
      ...
      <p className="text-xs md:text-sm leading-relaxed">
        Esen 26 Nakliyat olarak, tüm taşınma süreçlerimizi resmi nakliyat sözleşmesi düzenleyerek yürütmekteyiz. Güvenli bir nakliye süreci geçirmek adına sözleşmede bulunması gereken altı kritik kontrol maddesi ve gerekçeleri şunlardır:
      </p>
