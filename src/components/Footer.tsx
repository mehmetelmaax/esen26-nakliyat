...
export default function Footer() {
  ...
  const allRegions = [
    ...
    { name: 'Tepebaşı', href: '/bolgeler/tepebasi-evden-eve-nakliyat' },
    { name: 'Odunpazarı', href: '/bolgeler/odunpazari-evden-eve-nakliyat' },
    { name: 'Çifteler', href: '/bolgeler/cifteler-evden-eve-nakliyat' },
    { name: 'Sivrihisar', href: '/bolgeler/sivrihisar-evden-eve-nakliyat' },
    { name: 'Alpu', href: '/bolgeler/alpu-evden-eve-nakliyat' },
    { name: 'Beylikova', href: '/bolgeler/beylikova-evden-eve-nakliyat' },
    { name: 'İnönü', href: '/bolgeler/inonu-evden-eve-nakliyat' },
    { name: 'Mahmudiye', href: '/bolgeler/mahmudiye-evden-eve-nakliyat' },
    { name: 'Mihalgazi', href: '/bolgeler/mihalgazi-evden-eve-nakliyat' },
    { name: 'Mihalıççık', href: '/bolgeler/mihaliccik-evden-eve-nakliyat' },
    { name: 'Sarıcakaya', href: '/bolgeler/saricakaya-evden-eve-nakliyat' },
    { name: 'Seyitgazi', href: '/bolgeler/seyitgazi-evden-eve-nakliyat' },
    { name: 'Han', href: '/bolgeler/han-evden-eve-nakliyat' },
    { name: 'Günyüzü', href: '/bolgeler/gunyuzu-evden-eve-nakliyat' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-4 space-y-6">
            <Link href="/" className="flex items-center gap-2 group bg-white px-5 py-3 rounded-2xl shadow-xl border border-gray-light/20 w-fit">
              <Image
                src="/img/esen-26-logo-v3.png"
                alt="Esen Nakliyat & Temizlik & Kolileme logosu"
                width={160}
                height={64}
                loading="lazy"
          ...
          <div className="lg:col-span-3 space-y-4">
            <div className="border-b border-white/5 pb-2 lg:border-none lg:pb-0">
            ...
            <nav aria-label="Footer Hizmet Linkleri">
              <ul className="space-y-2 text-xs md:text-sm text-gray-300 font-semibold mt-4 lg:mt-0">
                <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 gap-4 text-xs text-gray-400 font-semibold pb-[env(safe-area-inset-bottom)] border-t border-white/5">
          ...
          <div className="text-center md:text-left">
            &copy; {currentYear} Esen 26 Nakliyat. Tüm hakları saklıdır. K3 Yetki Belgesi ile Hizmet Vermekteyiz.
          </div>
