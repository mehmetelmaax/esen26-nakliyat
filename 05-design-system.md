...
1. **Desktop Header & Footer**: Horizontal lockmark containing the stylized house-arrow glyph followed by the typography `ESEN 26 EVDEN EVE NAKLİYAT`. Recommended layout height is `48px` to fit inside the `64px` header with proper padding.
...
```json
{
  ...
  "@graph": [
    {
      "@type": "MovingCompany",
      "@id": "https://esen26nakliyat.com/#organization",
      "name": "Esen 26 Nakliyat",
      "alternateName": "Esen 26 Evden Eve Nakliyat",
      "url": "https://esen26nakliyat.com",
      "logo": {
        "@type": "ImageObject",
        "url": "https://esen26nakliyat.com/img/logo.png",
        "width": "200",
        "height": "60"
      },
      "telephone": "+905320126026",
    ...
    {
      "@type": "Service",
      "@id": "https://esen26nakliyat.com/#service-asansorlu",
