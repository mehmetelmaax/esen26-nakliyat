  ...
  for (const file of htmlFiles) {
    ...
    for (const match of ldJsonMatches) {
      ...
      const validateSchemaObj = (obj) => {
        ...
        // Regression check: no address fields in region pages (except for global MovingCompany/Organization)
        if (route.includes('/bolgeler/') && type !== 'MovingCompany' && type !== 'Organization') {
